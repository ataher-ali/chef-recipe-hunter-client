...
const Footer = () => {
  ...
  <div>
    <p>Copyright © 2023 - All right reserved by <Link to='/' className=' p-1 font-bold text-lg  rounded'> <span className='text-red-400 '>Rest </span> 🍌2 <span className='text-blue-500 ml-1'>Rent</span> </Link></p>
  </div>
</footer>
        </div>
    );
